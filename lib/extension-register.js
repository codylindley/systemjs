...
function register(loader) {
   ...
   * System.register for ES6 conversion - System.register([name, ]deps, declare)
  ...
  var anonRegister;
  var calledRegister;
  function doRegister(name, register) {
    calledRegister = true;
    // named register
    if (name) {
      register.name = name;
  ...
  /*
   * System.registerDynamic for dynamic modules (3-4 params) - System.registerDynamic([name, ]deps, executingRequire, execute)
   * the true or false statement 
   */
  function registerDynamic(name, deps, executingRequire, execute) {
    if (typeof name != 'string') {
      execute = executingRequire;
      executingRequire = deps;
      deps = name;
      name = null;
    }
  ...
  function defineRegister(loader) {
    ...
    loader.registerDynamic = registerDynamic;
  ...
  loader.instantiate = function(load) {
    ...
    // Contains System.register calls
      ...
      var curRegisterDynamic = System.registerDynamic;
      System.register = register;
      System.registerDynamic = registerDynamic;

      loader.__exec(load);

      System.register = curRegister;
      System.registerDynamic = curRegisterDynamic;
